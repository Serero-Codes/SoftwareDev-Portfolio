  ...
  return (
    ...
    >
      <div className="w-24 h-24 relative">
        <Suspense fallback={
          <div className="w-full h-full rounded-full bg-[#1a1f35] animate-pulse flex items-center justify-center">
      ...
      <div className="text-center">
        ...
        <p className="text-[#aaa6c3] text-xs mt-0.5">{tech.category}</p>
      </div>
    </motion.div>
  );
}
...
const Skills = () => {
  ...
  return (
    <>
      ...
      >
        From full-stack .NET applications to Python ML pipelines, here are the core technologies in my toolkit.
      </motion.p>
      ...
      {categories.map((cat) => (
        <div key={cat} className="mt-12">
          <div className="flex items-center gap-3 mb-8">
            <span className="text-[#915eff] text-sm font-semibold uppercase tracking-widest">{cat}</span>
